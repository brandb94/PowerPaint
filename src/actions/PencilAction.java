...
public class PencilAction extends AbstractAction {
     ...
     * also add the canvas to the constructors to get rid of the static method
     * @param theCanvas the drawing panel this action will affect.

     */
    public PencilAction(final DrawingArea theCanvas) {
        super("Pencil");
    ...
    public void actionPerformed(final ActionEvent theAction) {
        final Tool pencil = new PencilTool();
        myCanvas.setCurrentTool(pencil);
    }
